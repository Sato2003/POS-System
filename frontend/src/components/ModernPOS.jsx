    ...
    const renderPOSTab = () => (
        <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
            <div style={{ flex: 2, backgroundColor: 'white', borderRadius: '10px', padding: '20px' }}>
                ...
                <div style={{ marginBottom: '20px' }}><input type="text" placeholder="Search products..." value={search} onChange={(e) => setSearch(e.target.value)} style={{ width: '100%', padding: '12px', border: '1px solid #ddd', borderRadius: '5px' }} /></div>
            ...
            <div style={{ flex: 1, backgroundColor: 'white', borderRadius: '10px', padding: '20px' }}>
                <h2>Current Sale</h2>
                <div style={{ marginBottom: '20px' }}><input type="text" placeholder="Scan or enter barcode..." value={barcode} onChange={(e) => setBarcode(e.target.value)} onKeyPress={handleScan} style={{ width: '100%', padding: '12px', border: '2px solid #007bff', borderRadius: '5px' }} autoFocus /><div style={{ fontSize: '12px', color: '#666', marginTop: '5px' }}>Scan barcode and press Enter to add to cart</div></div>
                    ...
                    <div key={category} style={{ marginBottom: '30px' }}>
                        ...
                        <div style={{ overflowX: 'auto' }}>
                            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                                <thead><tr style={{ backgroundColor: '#f8f9fa', borderBottom: '2px solid #ddd' }}><th style={{ padding: '12px', textAlign: 'left' }}>PRODUCT</th><th style={{ padding: '12px', textAlign: 'left' }}>BARCODE</th><th style={{ padding: '12px', textAlign: 'left' }}>PRICE</th><th style={{ padding: '12px', textAlign: 'left' }}>STOCK</th><th style={{ padding: '12px', textAlign: 'left' }}>STATUS</th><th style={{ padding: '12px', textAlign: 'left' }}>ACTIONS</th></tr></thead>
                                <tbody>{groupedInventory[category].map(product => (
                                    <tr key={product._id} style={{ borderBottom: '1px solid #eee' }}>
                                        ...
                                        <td style={{ padding: '12px' }}><button onClick={() => handleEditClick(product)} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: '18px', marginRight: '10px' }} title="Edit">✏️</button><button onClick={() => handleDeleteProduct(product._id, product.name)} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: '18px', color: '#e74c3c' }} title="Delete">🗑️</button></td>
                                    </tr>
                                ))}</tbody>
                            </table>
                        </div>
